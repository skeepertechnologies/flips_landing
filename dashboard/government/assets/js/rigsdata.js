...
function fetchRigsData(token) {
    axios.get('http://flipsintel.org:8000/rigsdata/waterlevels/', {
            headers: {
...
function fetchSubscriptionDetails(token) {
    return axios.get('http://flipsintel.org:8000/subscription/details', {
            headers: {
                'Authorization': 'Token ' + token
            }
        })
...
function fetchAvailableUpgrades(token) {
    return axios.get('http://flipsintel.org:8000/subscription/upgrade/', {
            headers: {
                'Authorization': 'Token ' + token
            }
        })
